 ...
 * notification per version_code, and the daily job's network and period. Mirrors the
 * Cloudflare Usage Widget's UpdaterTest.
 */
@RunWith(RobolectricTestRunner.class)
@Config(sdk = {31, 35})
public final class UpdaterTest {

    private static final String BASE = "https://doskies-updates.example.dev";
    ...
    @Test public void newerVersionCodeIsAvailable() {
        Updater.CheckResult r = Updater.check(3, BASE,
            textSource(json(4, "1.2", "ABC", 4200, "DOSkies.apk", "In-app updates")));
    ...
    @Test public void equalVersionCodeIsUpToDate() {
        Updater.CheckResult r = Updater.check(3, BASE,
            textSource(json(3, "1.1", "ABC", 4200, "DOSkies.apk", "")));
    ...
    @Test public void defaultUpdateUrlIsDaltonsHost() {
        assertEquals("https://doskies-updates.daltonjfowler.workers.dev", store.updateUrl());
    }
