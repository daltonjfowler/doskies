 ...
 * available version and, when tapped, opens the app scrolled to the Updates card. It
 * carries no account data. Mirrors the Cloudflare Usage Widget's Notifications.
 */
final class Notifications {
     ...
     * names the version and, when tapped, opens the app at the Updates card. Posted at
     * most once per version_code by the daily job. It carries no account data.
     */
