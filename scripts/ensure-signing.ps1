...
& "$env:JAVA_HOME/bin/keytool.exe" -genkeypair -keystore $signingKey -alias doskies -keyalg RSA -keysize 3072 -validity 10000 -storepass:file $keypassFile -keypass:file $keypassFile -dname 'CN=DOSkies Personal Build' -noprompt
